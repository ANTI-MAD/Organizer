...
![Авторизация в приложении](../Sequence/Sequence1.PNG)

### 2. Добавление заметки<a name="2"></a>

![Добавление заметки](../Sequence/Sequence2.PNG)
  
### 3. Удаление заметки<a name="3"></a>

![Удаление заметки](../Sequence/Sequence3.PNG)

### 4. Просмотр заметки<a name="4"></a>

![Просмотр заметки](../Sequence/Sequence4.PNG)

### 5. Настройка профиля<a name="5"></a>

![Настройка профиля](../Sequence/Sequence5.PNG)
